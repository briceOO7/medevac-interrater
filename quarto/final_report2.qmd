...
fixed_table <- data.frame(
  Predictor = c(
    ...
    "  Confidence (within-person, per 1-point increase)",
    "  Confidence (between-person, per 1-point increase)",
  ...
  OR = c(NA, 1.00, or[2:4], NA, NA, or[5:7], NA, NA, 1.00, or[8:9]),
  CI_lower = c(NA, NA, or_lower[2:4], NA, NA, or_lower[5:7], NA, NA, NA, or_lower[8:9]),
  CI_upper = c(NA, NA, or_upper[2:4], NA, NA, or_upper[5:7], NA, NA, NA, or_upper[8:9]),
  p_value_raw = c(NA, NA, p_values[2:4], NA, NA, p_values[5:7], NA, NA, NA, p_values[8:9])
) %>%
  mutate(
    OR_display = case_when(
      Predictor %in% c("**Vignette Type**", "", "**Decision Characteristics**", "**Practice Location**") ~ "",
