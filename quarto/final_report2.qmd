...
**Note:** Special Considerations vignettes (Q16, Q17, Q18) excluded from model as sensitivity analysis. Model includes only clear Never (n=4), Possible (n=11), and Always (n=5) categories.

**Significant Predictors (p < 0.05):**

- **Vignette Type**: Compared to Never Medevac (reference):
  - Possible Medevac: OR = `r sprintf("%.2f", or[2])` (p < 0.001) - Higher odds compared to Never
  - Always Medevac: OR = `r sprintf("%.2f", or[3])` (p < 0.001) - Much higher odds compared to Never
