...
fixed_table <- data.frame(
  ...
  OR = c(NA, 1.00, or[2:4], NA, NA, or[5:6], NA, NA, 1.00, or[7:8]),
  CI_lower = c(NA, NA, or_lower[2:4], NA, NA, or_lower[5:6], NA, NA, NA, or_lower[7:8]),
  CI_upper = c(NA, NA, or_upper[2:4], NA, NA, or_upper[5:6], NA, NA, NA, or_upper[7:8]),
  p_value_raw = c(NA, NA, p_values[2:4], NA, NA, p_values[5:6], NA, NA, NA, p_values[7:8])
) %>%
  mutate(
