...
kable(variance_table,
  ...
  footnote(general = "Note: Physician random effect captures unmeasured risk tolerance and other stable physician characteristics after accounting for case-specific confidence, years of experience, and rural practice experience.",
           general_title = "")
```
