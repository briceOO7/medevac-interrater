...
vals <- c(vals, "",
          ...
          sprintf("%d vignettes", sum(agreement_categories$agreement_cat == "100%", na.rm = TRUE)),
          sprintf("%d vignettes", sum(agreement_categories$agreement_cat == "75-99%", na.rm = TRUE)),
          sprintf("%d vignettes", sum(agreement_categories$agreement_cat == "50-74%", na.rm = TRUE)),
          sprintf("%d vignettes", sum(agreement_categories$agreement_cat == "<50%", na.rm = TRUE)),
          "",
          "",
